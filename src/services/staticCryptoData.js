// Static cryptocurrency data service for performance optimization
// Provides mock data to maintain application functionality without external API dependencies

// Mock data for various cryptocurrencies
...
// Static data generator for current prices
...
// Static data generator for coin details
...
// Static data generator for market data
...
// Static data generator for historical prices
...
// Static data generator for global market data
...
// Static data generator for trending coins
...
export const transformStaticData = (coinData) => {
  return {
    id: coinData.id,
    name: coinData.name,
...
// Error handling for static data (simplified)
export const handleStaticDataError = (error) => {
  return { 
    error: 'Static data service error',
    type: 'static',
    retryable: false
  };
};

// Connection status (always returns connected for static data)
